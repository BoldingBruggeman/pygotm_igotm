...
setup(
    name='pygotm',
    version='0.1',
    description='Python driver for GOTM',
#    long_description=readme(),
    long_description_content_type='text/x-rst',
    url='https://github.com/gotm-model/code/tree/master',
...
#        ]
#    },
#KB    packages=['pygotm', 'pygotm/pygotm'],
    packages=['pygotm'],
    package_data={'pygotm': ['schemas/*', '*.so', '*.dll', '*.dylib']},
